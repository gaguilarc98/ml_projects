...
################################################################################
lim<-read.xlsx('C:/!bso/concentracion/limitesrangom.xlsx')
gc()
cc_list <- list.files('C:/!bso/concentracion/rdsFCST_m_rangom')
cc_list_2<-list()

for(i in 1:length(cc_list)){
  df<-readRDS(paste0('C:/!bso/concentracion/rdsFCST_m_rangom/',
                     cc_list[[i]]))
  cc_list_2[[i]]<-df
}
...
allExp_2 <- readRDS('C:/!bso/concentracion/proyrangom.rds')
i <- 3
...
ggsave(paste0('C:/!bso/concentracion/png/rangom_',unique(allExp_2$rangom)[[i]],
              '.png'))
...
lim2<-mean(gph$LimiteFinal)
  ...
  ggsave(paste0('C:/!bso/concentracion/png/rangom_pct_',unique(allExp_2$rangom)[[i]],
                '.png'))
