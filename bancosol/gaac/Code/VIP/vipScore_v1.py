...
#%%
# Update month here
df = pd.read_csv('C:/!bso/vipCartera/output/dataScore_ene2023.csv')
...
finalDF.to_excel('C:/!bso/vipCartera/output/vipList_wScores_ene2023.xlsx')
finalDF.to_csv('C:/!bso/vipCartera/output/vipList_wScores_ene2023.csv')
# %%
...
clfTab.to_csv('C:/!bso/vipCartera/output/clfTab_ene2023.csv')
# %%
