# -*- coding: utf-8 -*-
"""
Created on Thu Mar 30 14:39:10 2023
...
# Update month here
lastmonth = "Oct2023"
df = pd.read_csv('D:/!bso/vipCartera/dataScore_'+lastmonth+'.csv')
...
#finalDF.to_excel('D:/!bso/vipCartera/scores/vipList_wScores_'+lastmonth+'.xlsx')
finalDF.to_csv('D:/!bso/vipCartera/scores/vipList_wScores_'+lastmonth+'.csv')
# %%
...
clfTab.to_csv('D:/!bso/vipCartera/scores/clfTab_'+lastmonth+'.csv')
# %%
