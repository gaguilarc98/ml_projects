...
#%%
# Update month here
df = pd.read_csv('C:/!bso/vipCartera/output/dataScore_feb2023.csv')
df = df.set_index('CI', drop=True)
df = df.drop('GENERO', axis = 1)
df = df.drop('CI.y', axis = 1)
...
finalDF.to_excel('C:/!bso/vipCartera/output/vipList_wScores_feb2023.xlsx')
finalDF.to_csv('C:/!bso/vipCartera/output/vipList_wScores_feb2023.csv')
# %%
...
clfTab.to_csv('C:/!bso/vipCartera/output/clfTab_feb2023.csv')
# %%
