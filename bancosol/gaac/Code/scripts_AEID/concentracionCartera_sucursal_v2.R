...
write_rds(base, 'C:/!bso/concentracion/output/baseLimites.rds')

base<-readRDS('C:/!bso/concentracion/baseLimites.rds')
################################################################################
...
allExp_2 <- readRDS('C:/!bso/concentracion/proySucursal.rds')
i <- 3
...
ggsave(paste0('C:/!bso/concentracion/png/sucursal_',unique(allExp_2$sucursal)[[i]],
              '.png'))
...
lim2<-mean(gph$LimiteFinal)
  ...
  ggsave(paste0('C:/!bso/concentracion/png/sucursal_pct_',unique(allExp_2$sucursal)[[i]],
                '.png'))
