...
bdcOld <- readRDS('C:/!bso/cosechas/bdcFullCosechas_feb2023.rds')
...
write_rds(bdcFull_update, 'C:/!bso/cosechas/bdcFullCosechas_mar2023.rds')
bdcOld <- NULL
gc()
#============================================
remove(list = ls())
...
write_rds(coseY, 'C:/!bso/cosechas/coseY_mar2023.rds')
write_rds(coseY_ori, 'C:/!bso/cosechas/coseY_ori_mar2023.rds')
#===============================================================================
# Gráficas
coseY <- readRDS('C:/!bso/cosechas/coseY_mar2023.rds')
coseY_ori <- readRDS('C:/!bso/cosechas/coseY_ori_mar2023.rds')
gph <- coseY %>% 
...
ggplot(gph[gph$cosechaY <= 2022,], aes(x = mesPos, y = par0Rel, color = as.factor(cosechaY))) + 
  ...
  scale_color_manual(values = paleta(14)) + 
