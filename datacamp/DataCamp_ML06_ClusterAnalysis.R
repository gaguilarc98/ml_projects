...
#When a cluster is formed based on joining two closest observations then we need 
...
#The decision of how to select closest observation to a group is the LINKAGE CRITERIA.
...
#more efficient on large sets of data. But hierarchical clustering is usually a better
#theoretical option.
